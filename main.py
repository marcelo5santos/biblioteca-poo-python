""" Seção onde criamos o menu e a interface do usuário para interagir com a biblioteca."""
#menu
...
def menu():
    ...
    while True:
        ...
        elif opcao == "2":#seção de usuários
            while True:
                print("\n=== Opções de Usuários ===")
        ...
        elif opcao == "3":#seção de biblioteca
            opcoes_biblioteca = Opcoes_da_biblioteca()
